...
<div class ="container">
    ...
    <form action="editCategorie.php" method="POST" class="form-inline" role="form" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="" name="name" placeholder="Name of the categorie" value=<?php echo $Categorie['name']?>>
      </div>
      <div class="form-group">
        <label class="sr-only" for="">Descripcion</label>
        <input type="text" class="form-control" id="" name="description" placeholder="Description" value=<?php echo $Categorie['description']?>>
      </div>
      <div class="form-group">
